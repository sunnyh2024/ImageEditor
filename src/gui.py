...
class Window(QMainWindow):
    ...
    def createMenuBar(self):
        ...
        newProjMenu = fileMenu.addMenu('&New')
        self.newBlankAct = QAction('&Blank Project')
        self.newProjAct = QAction('&Image')
        newProjMenu.addActions([self.newBlankAct, self.newProjAct])
    ...
    def createDrawPanel(self):
        ...
        selectedColor.fill()
        self.selectedColorLabel = QLabel(alignment=Qt.AlignRight)
    ...
    def connect_features(self, features):
        ...
        """
        self.newProjAct.triggered.connect(features.newProject)
        self.newBlankAct.triggered.connect(features.newBlankProject)
        self.openAct.triggered.connect(features.openProject)
        self.saveAct.triggered.connect(features.saveImage)
        self.saveProjAct.triggered.connect(features.saveProject)
